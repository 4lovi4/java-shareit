...
requester_id bigint, created_time timestamp,
...
name varchar(255),description varchar(1024), available boolean,
...
create table if not exists bookings(id bigint generated always as identity  primary key,
item_id bigint, start_time timestamp, end_time timestamp,
